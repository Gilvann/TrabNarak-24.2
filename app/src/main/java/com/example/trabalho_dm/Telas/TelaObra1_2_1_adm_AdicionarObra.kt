...
@Composable
fun TelaObra1_2_1_adm_AdicionarObra(navController: NavController, colecao: String) {
                ...
                Button(
                    onClick = {
                        ...
                        fb.collection(colecao)
                            .document(titulo) // Define o nome do documento
                            .set(mapOf(
                                "titulo" to titulo,
                                "imagem" to "converter imagem em string", // dica: BASE64
